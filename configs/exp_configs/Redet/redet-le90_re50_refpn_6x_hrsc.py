_base_ = [
    '../../rotated_rtmdet/_base_/hrsc_rr.py', '../../_base_/schedules/schedule_6x.py',
    '../../_base_/default_runtime.py'
]

pretrained = '/media/ubuntu/nvidia/wlq/part2/mmrotate/configs/_wlq/Redet/re_resnet50_c8_batch256-25b16846.pth'
...
work_dir = './work_dirs/hrsc/redet/redet-le90_re50_refpn_6x_hrsc/'
