...
model = dict(
    ...
    bbox_head=dict(
        ...
        # loss_scale_ss=dict(type='GDLoss', loss_type='gwd', loss_weight=1.0)),
        loss_scale_ss=dict(type='mmdet.SmoothL1Loss', loss_weight=0.02, beta=0.1)),
...
work_dir = './work_dirs/hrsc/t2det_FOCS/t2det-le90_r50_fpn_rr-6x_hrsc_loss-scale-area_random-transform_new-decode/'
