...
train_dataloader = dict(dataset=dict(dataset=dict(pipeline=train_pipeline), times=3), batch_size=8, num_workers=8)
val_dataloader = dict(dataset=dict(pipeline=val_pipeline), batch_size=8, num_workers=8)
...
work_dir = './work_dirs/hrsc/h2rbox-v2/h2rbox-v2-le90_r50_fpn-6x_hrsc/'
